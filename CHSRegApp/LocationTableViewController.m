...
- (void)viewDidLoad
{
    ...
    self.collectionCellArray = @[@"8800 North Tryon", @"Directions to Location", @"Parking Information", @"704-863-6000"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = self.collectionCellArray[indexPath.row];
